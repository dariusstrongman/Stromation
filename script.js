...
function initContactForm() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            messageContainer.innerHTML = '<strong>Something went wrong.</strong> Please try again or email us directly at <a href="mailto:contact@stromation.com">contact@stromation.com</a>.';
        } finally {
            // Re-enable button
