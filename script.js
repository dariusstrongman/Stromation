...
class ScrollAnimations {
    ...
    initFadeIns() {
        const elements = document.querySelectorAll('.service-card, .service-card-large, .service-card-core, .demo-video-card, .demo-video-item, .demo-card, .pricing-card, .benefit-card, .testimonial-card, .stat-card');
